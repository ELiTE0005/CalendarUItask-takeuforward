    ...
    >
      ...
      >
        ...
        <div className="absolute inset-2 rounded-full bg-white/95 dark:bg-card border border-slate-200/70 dark:border-border/50 shadow-xl">
          ...
          {/* Hour hand */}
          <div
            className="absolute left-1/2 bottom-1/2 w-1 origin-bottom rounded-full transition-all duration-200 bg-slate-800 dark:bg-slate-200"
            style={{
              height: "28%",
          ...
          {/* Minute hand */}
          <div
            className="absolute left-1/2 bottom-1/2 w-0.5 origin-bottom rounded-full transition-all duration-200 bg-slate-500 dark:bg-slate-300"
            style={{
              height: "36%",
